...
- Pre-processing GT rules (section 4.2) can be found in [preprocessing.gt](./gt-rules/preprocessing.gt).
- Post-processing GT rules (section 4.4) can be found in [postprocessing.gt](./gt-rules/postprocessing.gt).
